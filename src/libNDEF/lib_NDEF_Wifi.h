...
typedef enum {
  ...
  NDEF_WIFI_AUTHENTICATION_WPA2_ENTRPRSE   = 0x0010, /**< WPS Authentication based on WPA2  */
  NDEF_WIFI_AUTHENTICATION_WPA2_PERSONAL   = 0x0020, /**< WPS Authentication based on WPA2  */
